...
async function closeRecoveryPhraseReminder(page) {
  const closeButtonLocator = page.locator(HomePage_default.recoveryPhraseReminder.gotItButton);
  await clickLocatorIfCondition(closeButtonLocator, () => closeButtonLocator.isVisible(), 1e3);
}
...
var openTransactionDetails = async (page, txIndex) => {
  ...
  await waitFor(() => page.locator(HomePage_default.popover.closeButton).isVisible(), 3e3);
};
var closeTransactionDetails = async (page) => {
  await page.locator(HomePage_default.popover.closeButton).click();
};
